var config = {};
config.filtersUrl = '/wp-json/util/tax/news_tax';
config.dataUrl = '/wp-json/wp/v2/news';
config.tax = 'news_tax';

angular.module('app', [])
    .controller('AppController', ['$scope', 'dataService', function($scope, dataService) {

        $scope.defaultImage = '/wp-content/themes/Main-Site-Theme/images/knight-head.jpg';
